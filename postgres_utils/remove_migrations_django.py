...
if __name__ == '__main__':
    ...
    try:
        ...
        # Remover migrations específicas
        migrations_a_remover = [
            {"app_name": "mines", "migration_name": "0002_alter_arquivo_arquivo"},
            {"app_name": "mines", "migration_name": "0003_mines_ocultar"},
            {"app_name": "slot", "migration_name": "0004_slot_ocultar"},
            {"app_name": "slot", "migration_name": "0005_alter_arquivo_arquivo"}
        ]
        db.remove_migration_entries(migrations_a_remover)
